        ...
        <asp:ListView runat="server" ID="lvPeliculas"
            ...
            <ItemTemplate>
                <table id="tablaPeliculas">
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="lblClasificacion" runat="server" CssClass="aspClasificacion"><%# Eval("Clasificacion")%></asp:Label>
                        </td>
                        <td>
                            <asp:Label ID="lblDuracion" runat="server" CssClass="aspDuracion"><%# Eval("Duracion")%></asp:Label>
                        </td>
                        <td>
