...
public partial class CinePeliculas : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            //acaba de obtener. Se asigna a la propiedad correspondiente del control lblCine
            lblCine.Text ="Cine:"+DataManager.GetNomCine(idCine);


            //Invoca al metodo de DataManager que corresponda para obtener todas las peliculas que tiene un cine
            //de acuerdo a su idCine. Se asigna al DataSource del listview
